      ...
      <div className="space-y-5">
        ...
        <div className="relative my-4">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-surface px-3 text-muted-foreground font-semibold uppercase tracking-wider text-[10px]">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className={`pl-11 h-12 rounded-xl bg-muted/30 border-border focus-visible:ring-1 focus-visible:ring-primary focus-visible:border-primary transition-all ${errors.fullName ? 'border-destructive' : ''}`}
                {...register('fullName')}
              />
            </div>
            {errors.fullName && (
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className={`pl-11 h-12 rounded-xl bg-muted/30 border-border focus-visible:ring-1 focus-visible:ring-primary focus-visible:border-primary transition-all ${errors.email ? 'border-destructive' : ''}`}
                {...register('email')}
              />
            </div>
            {errors.email && (
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className={`pl-11 h-12 rounded-xl bg-muted/30 border-border focus-visible:ring-1 focus-visible:ring-primary focus-visible:border-primary transition-all ${errors.password ? 'border-destructive' : ''}`}
                {...register('password')}
              />
            </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className={`pl-11 h-12 rounded-xl bg-muted/30 border-border focus-visible:ring-1 focus-visible:ring-primary focus-visible:border-primary transition-all ${errors.confirmPassword ? 'border-destructive' : ''}`}
