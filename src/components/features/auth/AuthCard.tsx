...
export function AuthCard({ children }: AuthCardProps) {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-secondary relative overflow-hidden px-4 py-12">
      {/* Decorative geometries using secondary color variants */}
      <div className="absolute right-0 top-0 h-full w-[25%] bg-secondary/80 transform skew-x-12 origin-top-right hidden md:block opacity-40 pointer-events-none" />
      <div className="absolute right-0 top-0 h-full w-[10%] bg-secondary/60 transform skew-x-6 origin-top-right hidden md:block opacity-60 pointer-events-none" />
